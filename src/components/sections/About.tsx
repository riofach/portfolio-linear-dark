...
export function About() {
  return (
    <section id="about" className="py-24 px-6 lg:px-8 border-b border-white/5 relative overflow-hidden">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6 text-lg text-gray-400 leading-relaxed">
              <p>
                ...
                in shipping digital products. My journey began with a curiosity for how things
                work on the web, which quickly evolved into a career obsession with creating
              ...
              <p>
                When I&apos;m not coding, you can find me exploring new coffee shops, contributing to
                open-source, or hiking the nearest trails.
              </p>
            </div>
