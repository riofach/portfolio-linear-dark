  ...
  return (
    <section id="contact" className="w-full max-w-7xl px-6 lg:px-8 py-20 mx-auto">
      <div className="grid md:grid-cols-2 gap-12 md:gap-24">
        <div className="flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-6">
              ...
              >
                <div
                  className="flex h-12 w-12 items-center justify-center rounded-lg bg-card-dark border border-border-dark group-hover:border-primary/50 transition-colors"
                >
                  <Mail className="w-6 h-6" />
                </div>
                <span className="text-lg font-medium">hello@portfolio.dev</span>
              </a>
              <div className="flex items-center gap-4 text-white">
                <div
                  className="flex h-12 w-12 items-center justify-center rounded-lg bg-card-dark border border-border-dark"
                >
          ...
          <div
            className="hidden md:block mt-12 p-6 rounded-xl bg-card-dark border border-border-dark relative overflow-hidden group"
          >
            <div
        ...
        {/* Contact Form */}
        <div
          className="bg-card-dark/50 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-border-dark shadow-xl"
        >
          <form className="flex flex-col gap-6">
            ...
            <label className="flex flex-col gap-2">
              ...
              <select
                className="w-full rounded-lg bg-background border border-border-dark px-4 py-3 text-white focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary transition-all appearance-none cursor-pointer"
              >
